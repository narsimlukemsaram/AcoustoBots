...
#define UDP_PORT 54007 // 7777
#define SERIAL_USB_BAUD 1000000

// Stepper Motor
const int steps_per_rev = 2048/2;
#define IN1 14
#define IN2 27
#define IN3 26
#define IN4 25
...
const char* networkName = "MSc_IoT"; // "ADMIN"; // "SwarmProject"; // replace with your network id
const char* networkPswd = "MSc_IoT@UCL"; // "MSc_IoT_2023_24"; // "MSD_GROUP"; // replace with your network password
  ...
  if (connected) {
    ...
    if (packetSize > 0) {
      ...
      for(int i = 0; i < len; i++){
        ...
        if(packet[i] == 'b'){
          // Stepper Motor
          Serial.println("Bead Dispenser Activated...!");
          // Turn LED 4 to show that the bead dispenser is activated
	        Set_LED(1,0,0,20);
	        Set_LED(2,0,0,20);
