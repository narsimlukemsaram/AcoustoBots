#ifndef _ASIER_INHO_UDP
#define _ASIER_INHO_UDP
...
namespace AsierInhoUDP {
	class _AsierInhoUDP_Export AsierInhoUDPBoard {
	protected:
		/**
...
# endif
	...
	_AsierInhoUDP_Export AsierInhoUDPBoard* createAsierInho();

	void printMessage(const char*);
	void printError(const char*);
	void printWarning(const char*);

	_AsierInhoUDP_Export void RegisterPrintFuncs(void(*p_Message)(const char*), void(*p_Warning)(const char*), void(*p_Error)(const char*));
};
